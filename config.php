...
*/
define('G5_DOMAIN', '');
define('G5_HTTPS_DOMAIN', 'https://int-x.co.kr');

/* SSL 적용 */
if(empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == "off"){
 $redirect = 'https://int-x.co.kr'. $_SERVER['REQUEST_URI'];
...
/* ygh - 240329 리다이렉션 작업 */
if ($_SERVER['HTTP_HOST'] === 'www.int-x.co.kr') {
    $redirect_url = 'https://int-x.co.kr' . $_SERVER['REQUEST_URI'];
